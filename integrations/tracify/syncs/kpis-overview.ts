...
import { connectionKpiQuery, getJsonSync, kpiOverviewResponse, savePayload } from '../shared.js';
...
const sync = createSync({
    description: 'Keeps the last 30 days of aggregated Tracify KPI overview data fresh.',
    version: '1.0.0',
    endpoints: [
        {
            method: 'GET',
    ...
    exec: async (nango) => {
        ...
        const payload = kpiOverviewResponse.parse(await getJsonSync(nango, '/analytics/api/v1/kpis/overview/', input));
