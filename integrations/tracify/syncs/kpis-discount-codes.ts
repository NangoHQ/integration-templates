...
import { connectionKpiQuery, getJsonSync, kpiDiscountCodesResponse, savePayload } from '../shared.js';
...
const sync = createSync({
    description: 'Keeps the last 30 days of Tracify discount-code KPI data fresh.',
    version: '1.0.0',
    endpoints: [
        {
            method: 'GET',
    ...
    exec: async (nango) => {
        ...
        const payload = kpiDiscountCodesResponse.parse(await getJsonSync(nango, '/analytics/api/v1/kpis/discount_codes', input));
