...
const action = createAction({
    ...
    exec: async (nango, input): Promise<z.infer<typeof OutputSchema>> => {
        ...
        return {
            ...
            ...(providerDeal.winProbability != null && { winProbability: providerDeal.winProbability }),
            ...(providerDeal.winProbabilityMdate != null && { winProbabilityMdate: providerDeal.winProbabilityMdate }),
