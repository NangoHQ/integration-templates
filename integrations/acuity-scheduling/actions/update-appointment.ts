...
const ProviderAppointmentSchema = z.object({
    ...
    classID: z.union([z.number(), z.null()]).optional(),
    duration: z.union([z.string(), z.number()]).optional(),
    calendar: z.string().optional(),
    calendarID: z.number().optional(),
    location: z.string().optional(),
    certificate: z.union([z.string(), z.null()]).optional(),
    confirmationPage: z.string().optional(),
    formsText: z.string().optional(),
    notes: z.string().optional(),
    timezone: z.string().optional(),
    forms: z.array(ProviderFormSchema).optional(),
    labels: z.union([z.array(ProviderLabelSchema), z.null()]).optional(),
...
const action = createAction({
    ...
    endpoint: {
        method: 'POST',
        path: '/actions/update-appointment',
        group: 'Appointments'
    },
    input: InputSchema,
    output: OutputSchema,
