import type { NangoSync, RecruiterFlowCandidateScorecard, ProxyConfiguration, RecruiterFlowCandidateScorecardInput } from '../../models';
import { recruiterFlowCandidateScorecardInputSchema } from '../schema.zod.js';

export default async function runAction(nango: NangoSync, input: RecruiterFlowCandidateScorecardInput): Promise<RecruiterFlowCandidateScorecard> {
