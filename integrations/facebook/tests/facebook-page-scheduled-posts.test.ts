...
import createSync from '../syncs/page-scheduled-posts.js';

describe('facebook page-scheduled-posts tests', () => {
  const models = 'PageScheduledPost'.split(',');

  const createTestContext = () => {
    const nangoMock = new global.vitest.NangoSyncMock({
      dirname: __dirname,
      name: "page-scheduled-posts",
      Model: "PageScheduledPost"
    });
