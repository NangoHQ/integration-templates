...
import createSync from '../syncs/documents-from-shared-drives.js';

describe('google-docs documents-from-shared-drives tests', () => {
    const models = 'SharedDriveDocument'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'documents-from-shared-drives',
            Model: 'SharedDriveDocument'
        });
