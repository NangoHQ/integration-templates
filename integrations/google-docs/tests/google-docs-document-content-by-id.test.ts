...
import createSync from '../syncs/document-content-by-id.js';

describe('google-docs document-content-by-id tests', () => {
    const models = 'DocumentContent'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'document-content-by-id',
