...
import createSync from '../syncs/documents-from-drive-folders.js';

describe('google-docs documents-from-drive-folders tests', () => {
  const models = 'FolderDocument'.split(',');

  const createTestContext = () => {
    const nangoMock = new global.vitest.NangoSyncMock({
      dirname: __dirname,
      name: "documents-from-drive-folders",
