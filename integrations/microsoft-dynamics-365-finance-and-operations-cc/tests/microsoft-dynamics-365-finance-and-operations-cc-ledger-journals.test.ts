...
import createSync from '../syncs/ledger-journals.js';

describe('microsoft-dynamics-365-finance-and-operations-cc ledger-journals tests', () => {
  const models = 'LedgerJournal'.split(',');
