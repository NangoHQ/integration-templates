...
import createSync from '../syncs/customer-payment-journals.js';

describe('microsoft-dynamics-365-finance-and-operations-cc customer-payment-journals tests', () => {
  const models = 'CustomerPaymentJournalHeader'.split(',');

  const createTestContext = () => {
    const nangoMock = new global.vitest.NangoSyncMock({
      dirname: __dirname,
      name: "customer-payment-journals",
      Model: "CustomerPaymentJournalHeader"
    });
