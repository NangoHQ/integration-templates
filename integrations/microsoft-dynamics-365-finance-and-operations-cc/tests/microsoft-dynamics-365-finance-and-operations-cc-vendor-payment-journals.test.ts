...
import createSync from '../syncs/vendor-payment-journals.js';

describe('microsoft-dynamics-365-finance-and-operations-cc vendor-payment-journals tests', () => {
  const models = 'VendorPaymentJournal'.split(',');

  const createTestContext = () => {
    const nangoMock = new global.vitest.NangoSyncMock({
      dirname: __dirname,
      name: "vendor-payment-journals",
      Model: "VendorPaymentJournal"
    });
