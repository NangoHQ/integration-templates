...
import createSync from '../syncs/purchase-orders.js';

describe('microsoft-dynamics-365-finance-and-operations-cc purchase-orders tests', () => {
  const models = 'PurchaseOrder'.split(',');
