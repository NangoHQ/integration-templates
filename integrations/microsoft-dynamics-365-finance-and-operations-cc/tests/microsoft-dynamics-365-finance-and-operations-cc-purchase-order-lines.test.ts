...
import createSync from '../syncs/purchase-order-lines.js';

describe('microsoft-dynamics-365-finance-and-operations-cc purchase-order-lines tests', () => {
  const models = 'PurchaseOrderLine'.split(',');
