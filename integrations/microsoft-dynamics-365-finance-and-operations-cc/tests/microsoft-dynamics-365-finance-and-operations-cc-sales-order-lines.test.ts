...
import createSync from '../syncs/sales-order-lines.js';

describe('microsoft-dynamics-365-finance-and-operations-cc sales-order-lines tests', () => {
  const models = 'SalesOrderLine'.split(',');
