...
import createSync from '../syncs/legal-entities.js';

describe('microsoft-dynamics-365-finance-and-operations-cc legal-entities tests', () => {
  const models = 'LegalEntity'.split(',');
