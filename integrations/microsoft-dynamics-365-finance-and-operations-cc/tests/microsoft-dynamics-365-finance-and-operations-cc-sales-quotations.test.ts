...
import createSync from '../syncs/sales-quotations.js';

describe('microsoft-dynamics-365-finance-and-operations-cc sales-quotations tests', () => {
  const models = 'SalesQuotation'.split(',');
