...
import createSync from '../syncs/main-accounts.js';

describe('microsoft-dynamics-365-finance-and-operations-cc main-accounts tests', () => {
  const models = 'MainAccount'.split(',');
