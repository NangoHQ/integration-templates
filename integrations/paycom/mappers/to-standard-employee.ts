import type { StandardEmployee, Phone, Email, Address, Person } from '../models.js';
 ...
 */
export function toStandardEmployeeDetailed(employee: PaycomDetailedEmployee): StandardEmployee {
    const firstName = employee.firstname || '';
    const lastName = employee.lastname || '';
    const displayName = employee.employee_name || `${firstName} ${lastName}`.trim();
    ...
    const manager: Person | undefined = employee.supervisor_primary_code
        ? {
              ...
              lastName: employee.supervisor_primary?.split(' ').slice(1).join(' ') || '',
    ...
    const baseEmployee: StandardEmployee = {
        ...
        // Employment details
        title: employee.business_title || employee.position_title || employee.position || '',
        department: {
        ...
        providerSpecific: {
            ...
            actual_marital_status_description: employee.actual_marital_status_description,
            age: employee.age,
            ...
            employee_terminal_group_description: employee.employee_terminal_group_description,
            location: employee.location,
            schedule_group: employee.schedule_group,
            schedule_time_zone: employee.schedule_time_zone,
            primary_schedule_group_description: employee.primary_schedule_group_description,
