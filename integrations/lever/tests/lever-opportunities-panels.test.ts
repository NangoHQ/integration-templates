...
import createSync from '../syncs/opportunities-panels.js';

describe('lever-basic opportunities-panels tests', () => {
    const models = 'LeverOpportunityPanel'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'opportunities-panels',
            Model: 'LeverOpportunityPanel'
        });
