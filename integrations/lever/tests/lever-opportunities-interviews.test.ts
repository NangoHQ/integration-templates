...
import createSync from '../syncs/opportunities-interviews.js';

describe('lever-basic opportunities-interviews tests', () => {
    const models = 'LeverOpportunityInterview'.split(',');
