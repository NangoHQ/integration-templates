...
import createSync from '../syncs/requisition-fields.js';

describe('lever-basic requisition-fields tests', () => {
    const models = 'RequisitionField'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'requisition-fields',
            Model: 'RequisitionField'
        });
