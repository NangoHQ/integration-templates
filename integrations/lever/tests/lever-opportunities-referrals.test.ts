...
import createSync from '../syncs/opportunities-referrals.js';

describe('lever-basic opportunities-referrals tests', () => {
    const models = 'Referral'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'opportunities-referrals',
            Model: 'Referral'
        });
