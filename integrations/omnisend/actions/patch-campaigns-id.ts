...
const input = z.object({"id": z.string().min(1), body: z.object({"abTest": z.object({"settings": z.object({"decisionTime": z.unknown().optional(), "testSizePercent": z.unknown().optional(), "winningMetric": z.unknown().optional()}).passthrough().optional(), "variants": z.object({"a": z.unknown().optional(), "b": z.unknown().optional()}).passthrough().optional()}).passthrough().optional(), "audience": z.object({"excludedSegmentIDs": z.array(z.unknown()).optional(), "includedSegmentIDs": z.array(z.unknown()).optional()}).passthrough().optional(), "boosterSettings": z.object({"delay": z.object({"amount": z.unknown(), "unit": z.unknown()}).passthrough().optional(), "sendTo": z.enum(["nonOpeners", "nonClickers"]).optional()}).passthrough().optional(), "content": z.object({"email": z.object({"preheader": z.unknown().optional(), "replyToEmail": z.unknown().optional(), "senderEmail": z.unknown().optional(), "senderName": z.unknown().optional(), "subject": z.unknown().optional()}).passthrough().optional(), "sms": z.object({"compliance": z.unknown().optional(), "imageID": z.unknown().optional(), "isLinkShorteningEnabled": z.unknown().optional(), "message": z.unknown().optional()}).passthrough().optional()}).passthrough().optional(), "language": z.string().optional(), "name": z.string().optional(), "sendingSettings": z.object({"isTZOptimizationEnabled": z.boolean().optional(), "optimizeFor": z.enum(["opens", "clicks", "orders"]).optional(), "scheduledAt": z.string().optional(), "strategy": z.enum(["immediate", "scheduled", "personalized"]).optional()}).passthrough().optional()}).passthrough()}).passthrough();
...
const action = createAction({
    ...
    (await callOmnisend(nango, 'PATCH', '/campaigns/{id}', requestInput as Record<string, unknown>)).data
    )
});
