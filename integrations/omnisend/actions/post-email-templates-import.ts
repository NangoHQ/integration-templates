...
const input = z.object({body: z.object({"html": z.string().optional(), "name": z.string().optional()}).passthrough()}).passthrough();
...
const action = createAction({
    ...
    (await callOmnisend(nango, 'POST', '/email-templates/import', requestInput as Record<string, unknown>)).data
    )
});
