...
const output = z.object({"categoryID": z.string().optional(), "createdAt": z.string().optional(), "title": z.string().optional(), "updatedAt": z.string().optional()}).passthrough();
...
const action = createAction({
    ...
    (await callOmnisend(nango, 'GET', '/product-categories/{categoryID}', requestInput as Record<string, unknown>)).data
    )
});
