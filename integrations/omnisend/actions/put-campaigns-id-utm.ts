...
const input = z.object({"id": z.string().min(1), body: z.object({"tags": z.object({"campaign": z.string().optional(), "medium": z.string().optional(), "source": z.string().optional()}).passthrough().optional(), "variants": z.object({"a": z.object({"campaign": z.unknown().optional(), "medium": z.unknown().optional(), "source": z.unknown().optional()}).passthrough().optional(), "b": z.object({"campaign": z.unknown().optional(), "medium": z.unknown().optional(), "source": z.unknown().optional()}).passthrough().optional()}).passthrough().optional()}).passthrough()}).passthrough();
...
const action = createAction({
    ...
    (await callOmnisend(nango, 'PUT', '/campaigns/{id}/utm', requestInput as Record<string, unknown>)).data
    )
});
