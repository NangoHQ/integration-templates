...
import createSync from '../syncs/incoming-phone-numbers.js';

describe('twilio incoming-phone-numbers tests', () => {
    const models = 'IncomingPhoneNumber'.split(',');
    ...
    const createTestContext = () => {
        ...
        nangoMock.getConnection = vi.fn(async () => ({
            credentials: {
                type: 'BASIC',
                username: 'ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa00'
            }
        }));
