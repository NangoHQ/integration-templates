...
const Input = z.object({
    ...
    length: z.number().describe('Size of the file in bytes. Example: 1024')
});

const Output = z.object({
    ok: z.boolean().describe('Whether the request was successful'),
    upload_url: z.string().describe('The URL to upload the file to'),
    file_id: z.string().describe('The file ID to use when completing the upload')
});
