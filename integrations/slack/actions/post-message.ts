...
const OutputSchema = z.object({
    ...
    message: z
        .object({
            ...
            subtype: z.union([z.string(), z.null()]).optional().describe('Message subtype'),
            text: z.string().describe('Text of the message'),
            ts: z.string().describe('Timestamp of the message'),
            username: z.union([z.string(), z.null()]).optional().describe('Username of the sender'),
            bot_id: z.union([z.string(), z.null()]).optional().describe('ID of the bot if sent by bot')
        })
    ...
    exec: async (nango, input): Promise<z.infer<typeof OutputSchema>> => {
        ...
        return {
            ...
            message: {
                ...
                subtype: response.data.message.subtype || null,
                text: response.data.message.text,
                ts: response.data.message.ts,
                username: response.data.message.username || null,
                bot_id: response.data.message.bot_id || null
            }
        };
    }
});
