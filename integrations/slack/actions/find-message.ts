...
const OutputSchema = z.object({
    ...
    next_cursor: z.union([z.string(), z.null()]).describe('Pagination cursor for the next page, or null if no more results')
});
...
const action = createAction({
    ...
    exec: async (nango, input): Promise<z.infer<typeof OutputSchema>> => {
        ...
        const nextCursor = response.data.messages?.pagination?.next_cursor || null;
