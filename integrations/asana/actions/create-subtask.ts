...
const InputSchema = z.object({
    ...
    assignee: z.string().nullable().optional().describe('The user gid to assign the subtask to, or null for no assignee. Example: "67890"'),
    due_on: z.string().nullable().optional().describe('Localized due date in YYYY-MM-DD format, or null for no due date. Example: "2024-12-31"'),
    due_at: z.string().nullable().optional().describe('UTC due date-time in ISO 8601 format, or null for no due time. Example: "2024-12-31T23:59:59.000Z"'),
    ...
    start_on: z.string().nullable().optional().describe('Start date in YYYY-MM-DD format, or null for no start date. Example: "2024-01-01"'),
