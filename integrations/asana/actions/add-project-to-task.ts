...
const InputSchema = z.object({
    ...
    section: z.string().nullable().optional().describe('The section to add the task to within the project, or null for no section. Example: "1200000000000003"'),
    insert_after: z.string().nullable().optional().describe('A task ID to position this task after, or null to insert at the beginning. Example: "1200000000000004"'),
    insert_before: z.string().nullable().optional().describe('A task ID to position this task before, or null to insert at the end. Example: "1200000000000005"')
});
