...
import createSync from '../syncs/connect-configurations.js';

describe('docusign connect-configurations tests', () => {
    const models = 'ConnectConfiguration'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'connect-configurations',
            Model: 'ConnectConfiguration'
        });
