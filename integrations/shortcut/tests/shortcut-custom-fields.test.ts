...
import createSync from '../syncs/custom-fields.js';

describe('shortcut custom-fields tests', () => {
    const models = 'CustomField'.split(',');
    ...
    it('should track deletes via trackDeletesStart/trackDeletesEnd', async () => {
