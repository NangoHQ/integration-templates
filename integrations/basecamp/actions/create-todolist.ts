...
const action = createAction({
    ...
    exec: async (nango, input): Promise<z.infer<typeof OutputSchema>> => {
        ...
        return {
            ...
            creator: {
                id: providerTodolist.creator.id,
                attachable_sgid: providerTodolist.creator.attachable_sgid,
                name: providerTodolist.creator.name,
                personable_type: providerTodolist.creator.personable_type,
                title: providerTodolist.creator.title,
                tagline: providerTodolist.creator.tagline,
                location: providerTodolist.creator.location,
                created_at: providerTodolist.creator.created_at,
                updated_at: providerTodolist.creator.updated_at,
                ...(providerTodolist.creator.email_address != null && { email_address: providerTodolist.creator.email_address }),
                bio: providerTodolist.creator.bio,
                admin: providerTodolist.creator.admin,
                owner: providerTodolist.creator.owner,
                client: providerTodolist.creator.client,
                employee: providerTodolist.creator.employee,
                time_zone: providerTodolist.creator.time_zone,
                avatar_url: providerTodolist.creator.avatar_url,
                ...(providerTodolist.creator.company !== undefined && { company: providerTodolist.creator.company }),
                can_ping: providerTodolist.creator.can_ping,
                can_manage_projects: providerTodolist.creator.can_manage_projects,
                can_manage_people: providerTodolist.creator.can_manage_people,
                can_access_timesheet: providerTodolist.creator.can_access_timesheet,
                can_access_hill_charts: providerTodolist.creator.can_access_hill_charts
            },
