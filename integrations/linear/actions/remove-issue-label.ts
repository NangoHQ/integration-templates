...
const InputSchema = z.object({
    issueId: z.string().describe('The ID of the issue to remove the label from. Example: "c7a3f0e2-1b2d-4e3f-9a0b-1c2d3e4f5a6b"'),
    labelId: z.string().describe('The ID of the label to remove. Example: "a1b2c3d4-5e6f-7a8b-9c0d-1e2f3a4b5c6d"')
});
