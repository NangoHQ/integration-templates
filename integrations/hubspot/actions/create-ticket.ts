...
const action = createAction({
    ...
    exec: async (nango, input): Promise<z.infer<typeof OutputSchema>> => {
        ...
        return {
            ...
            hs_pipeline: data.properties?.['hs_pipeline'] ?? null,
            hs_pipeline_stage: data.properties?.['hs_pipeline_stage'] ?? null,
            hs_ticket_priority: data.properties?.['hs_ticket_priority'] ?? null,
