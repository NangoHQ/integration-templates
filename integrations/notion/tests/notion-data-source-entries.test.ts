...
import createSync from '../syncs/data-source-entries.js';

describe('notion data-source-entries tests', () => {
    const models = 'DataSourceEntry'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'data-source-entries',
