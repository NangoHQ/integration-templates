...
import createSync from '../syncs/targeting-templates.js';

describe('pinterest targeting-templates tests', () => {
    const models = 'TargetingTemplate'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'targeting-templates',
