...
import createSync from '../syncs/catalog-product-groups.js';

describe('pinterest catalog-product-groups tests', () => {
    const models = 'CatalogProductGroup'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'catalog-product-groups',
            Model: 'CatalogProductGroup'
        });
