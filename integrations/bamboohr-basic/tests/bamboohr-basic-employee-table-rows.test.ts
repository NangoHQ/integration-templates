...
import createSync from '../syncs/employee-table-rows.js';

describe('bamboohr employee-table-rows tests', () => {
    const models = 'EmployeeTableRow'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'employee-table-rows',
            Model: 'EmployeeTableRow'
        });
