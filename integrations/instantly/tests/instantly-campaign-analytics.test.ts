...
import createSync from '../syncs/campaign-analytics.js';

// The fixture uses start_date=2026-06-01, end_date=2026-07-01 (30-day window ending today).
...
describe('instantly campaign-analytics tests', () => {
    const models = 'CampaignAnalytics,CampaignAnalyticsOverview,CampaignAnalyticsDaily,CampaignAnalyticsSteps'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'campaign-analytics',
            Model: 'CampaignAnalytics,CampaignAnalyticsOverview,CampaignAnalyticsDaily,CampaignAnalyticsSteps'
        });
