...
const ProviderAccountSchema = z.object({
    ...
    daily_limit_max: z.number().nullish(),
    warmup_limit_max: z.number().nullish(),
    stat_warmup_score: z.number().nullish(),
    setup_pending: z.boolean().optional(),
    is_managed_account: z.boolean().optional(),
    is_ready_made_account: z.boolean().nullish(),
    dfy_password_changed: z.boolean().nullish(),
    tracking_domain_name: z.string().nullish(),
    tracking_domain_status: z.string().nullish(),
    reply_to: z.string().nullish(),
    signature: z.string().nullish(),
    sending_gap: z.number().optional(),
    enable_slow_ramp: z.boolean().nullish(),
    inbox_placement_test_limit: z.number().nullish(),
    timestamp_last_used: z.string().nullish(),
    timestamp_warmup_start: z.string().nullish(),
    warmup_pool_id: z.string().nullish(),
    added_by: z.string().nullish(),
    modified_by: z.string().nullish(),
    status_message: z.record(z.string(), z.unknown()).nullish()
});
