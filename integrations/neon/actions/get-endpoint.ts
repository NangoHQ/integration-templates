...
// Operation: getProjectEndpoint
const InputSchema = z.object({ project_id: z.string().regex(new RegExp('^[a-z0-9-]{1,60}$')), endpoint_id: z.string().regex(new RegExp('^[a-z0-9-]{1,60}$')) });
