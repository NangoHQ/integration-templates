...
const InputSchema = z.object({
    ...
    body: z.object({
        branch: z
            ...
            .describe('Branch attributes to update. Supply only the fields you want to change, for example `name` or `protected`.')
    })
});
