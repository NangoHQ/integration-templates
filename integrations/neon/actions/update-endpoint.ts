...
// Operation: updateProjectEndpoint
const InputSchema = z
    .object({
            ...
            endpoint: z
                .object({
                    branch_id: z
                        ...
                        .describe('Deprecated. The destination branch ID; must not have an existing read-write endpoint.\n')
                        .optional(),
                ...
                .describe('Parameters for the compute endpoint update.')
        })
    })
    .refine(
        (input) =>
