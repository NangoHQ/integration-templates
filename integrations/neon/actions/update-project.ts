                ...
                .object({
                    quota: z
                        .object({
                            ...
                            compute_time_seconds: z
                                ...
                                .optional(),
                            written_data_bytes: z.number().int().min(0).describe("Total amount of data written to all of a project's branches.\n").optional(),
                    ...
                    maintenance_window: z
                        .object({
                            weekdays: z
                                .array(z.number().int())
                                .describe('A list of weekdays when the maintenance window is active.\nEncoded as ints, where 1 - Monday, and 7 - Sunday.\n'),
