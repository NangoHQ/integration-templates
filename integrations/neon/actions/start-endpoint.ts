...
// Operation: startProjectEndpoint
...
const action = createAction({
    ...
    exec: async (nango, input): Promise<z.infer<typeof OutputSchema>> => {
        const config: ProxyConfiguration = {
            ...
            endpoint: `/v2/projects/${encodeURIComponent(input['project_id'])}/endpoints/${encodeURIComponent(input['endpoint_id'])}/start`,
