...
import createSync from '../syncs/user-files-selection.js';

describe('one-drive-personal user-files-selection tests', () => {
    const models = 'UserFileSelection'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'user-files-selection',
            Model: 'UserFileSelection'
        });
