...
import createSync from '../syncs/custom-categories.js';

describe('dope-security custom-categories tests', () => {
    const models = 'CustomCategory'.split(',');
