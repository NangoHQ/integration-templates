...
import createSync from '../syncs/customer-invoice-templates.js';

describe('pennylane customer-invoice-templates tests', () => {
    const models = 'CustomerInvoiceTemplate'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'customer-invoice-templates',
            Model: 'CustomerInvoiceTemplate'
        });
