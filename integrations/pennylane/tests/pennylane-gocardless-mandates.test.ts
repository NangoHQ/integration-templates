...
import createSync from '../syncs/gocardless-mandates.js';

describe('pennylane gocardless-mandates tests', () => {
    const models = 'PennylaneGocardlessMandate'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'gocardless-mandates',
            Model: 'PennylaneGocardlessMandate'
        });
