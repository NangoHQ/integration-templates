...
import createSync from '../syncs/pro-account-mandates.js';

describe('pennylane pro-account-mandates tests', () => {
    const models = 'ProAccountMandate'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'pro-account-mandates',
            Model: 'ProAccountMandate'
        });
