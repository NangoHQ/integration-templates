...
import createSync from '../syncs/bank-establishments.js';

describe('pennylane bank-establishments tests', () => {
    const models = 'BankEstablishment'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'bank-establishments',
            Model: 'BankEstablishment'
        });
