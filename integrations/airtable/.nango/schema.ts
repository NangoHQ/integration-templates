...
export interface WebhookSpecification {
    options: {
        filters: {
            ...
            changeTypes?: string[];
            fromSources?: string[];
            sourceOptions?: { formPageSubmission?: { pageId: string }; formSubmission?: { viewId: string } };
            watchDataInFieldIds?: string[];
            watchSchemasOfFieldIds?: string[];
        };
        includes?: { includeCellValuesInFieldIds?: string[] | 'all'; 'includePreviousCellValues:'?: boolean; includePreviousFieldDefinitions?: boolean };
    };
}
