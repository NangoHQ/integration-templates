...
import createSync from '../syncs/contracted_invoices.js';

describe('ingenious-build contracted_invoices tests', () => {
    const models = 'ContractedInvoice'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'contracted_invoices',
            Model: 'ContractedInvoice'
        });
