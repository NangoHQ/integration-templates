...
import createSync from '../syncs/journal-entries.js';

describe('quickbooks journal-entries tests', () => {
    const models = 'JournalEntry'.split(',');
    ...
    const createTestContext = () => {
        ...
        nangoMock.getConnection.mockImplementation(async () => ({
            connection_config: {
