...
const InputSchema = z.object({
    body: z.object({
        ...
        incident_role_assignments: z
            .array(
                z.object({
                    assignee: z.object({ email: z.string().optional(), id: z.string().optional(), slack_user_id: z.string().optional() }).optional(),
                    incident_role_id: z.string()
                })
            )
            .optional(),
        incident_status_id: z.string().optional(),
        incident_timestamp_values: z.array(z.object({ incident_timestamp_id: z.string(), value: z.string().optional() })).optional(),
        ...
        retrospective_incident_options: z
            .object({ external_id: z.number().int().optional(), postmortem_document_url: z.string().optional(), slack_channel_id: z.string().optional() })
            .optional(),
