...
const cases = [
    ...
    { name: "get-postmortem-document-content", method: "get", path: "/v1/postmortem_documents/{id}/content", hasBody: false, action: getPostmortemDocumentContent },
    ...
    { name: "list-incident-participant-workloads", method: "get", path: "/v2/incident_participant_workloads", hasBody: false, action: listIncidentParticipantWorkloads },
    ...
    { name: "list-user-notification-methods", method: "get", path: "/v2/users/{user_id}/notification_methods", hasBody: false, action: listUserNotificationMethods },
    ...
    { name: "connect-follow-up-external-issue", method: "post", path: "/v3/follow_ups/{id}/actions/connect_external_issue", hasBody: true, action: connectFollowUpExternalIssue },
