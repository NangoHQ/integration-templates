...
const InputSchema = z
    .object({
        ...
        forum_type: z.number().optional().describe("Type of forum. 1 = How To's, 2 = Ideas, 3 = Problems, 4 = Announcements."),
        forum_visibility: z
            .number()
            .optional()
...
const OutputSchema = z
    .object({
        ...
        posts_count: z.number().optional().describe('Total number of posts in the forum.'),
        company_ids: z.array(z.number()).optional().describe('Company IDs allowed to view the forum when forum_visibility is 4.')
    })
...
const action = createAction({
    ...
    exec: async (nango, input): Promise<z.infer<typeof OutputSchema>> => {
        ...
        const forum = OutputSchema.parse(response.data);
        return forum;
    }
});
