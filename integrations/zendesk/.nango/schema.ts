...
export interface CategoryCreate {
    category: { name: string; description?: string | undefined };
}
...
export interface SectionCreate {
    category_id: number;
    section: { name: string; description?: string | undefined };
}
...
export interface TicketCreate {
    ticket: {
        comment: { body?: string | undefined; html_body?: string | undefined };
