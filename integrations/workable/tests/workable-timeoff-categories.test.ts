...
import createSync from '../syncs/timeoff-categories.js';

describe('workable timeoff-categories tests', () => {
    const models = 'TimeOffCategory'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'timeoff-categories',
