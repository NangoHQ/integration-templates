...
import createSync from '../syncs/disqualification-reasons.js';

describe('workable disqualification-reasons tests', () => {
    const models = 'DisqualificationReason'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'disqualification-reasons',
