...
// Operation: contacts/list-segments
const InputSchema = z
...
const action = createAction({
    description: 'Retrieve a list of segments for a contact in Resend. Returns one page; pass next_cursor as after to continue.',
    version: '1.0.0',
    input: InputSchema,
    output: OutputSchema,
    scopes: [],
