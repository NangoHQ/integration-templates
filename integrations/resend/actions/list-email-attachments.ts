...
// Operation: emails/list-attachments
const InputSchema = z
...
const action = createAction({
    description: 'Retrieve a list of attachments for a sent email in Resend. Returns one page; pass next_cursor as after to continue.',
    version: '1.0.0',
    input: InputSchema,
    output: OutputSchema,
    scopes: [],
