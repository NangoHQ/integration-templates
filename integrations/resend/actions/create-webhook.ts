...
const InputSchema = z.object({ body: z.object({ endpoint: z.string(), events: z.array(z.string()).min(1) }).passthrough() }).passthrough();

const ProviderResponseSchema = z.object({ object: z.string().optional(), id: z.string().optional(), signing_secret: z.string().optional() }).passthrough();
