...
// Operation: webhooks/list-event-attempts
const InputSchema = z
    .object({ webhook_id: z.string(), event_id: z.string(), limit: z.number().int().min(1).max(100).optional(), after: z.string().optional() })
    .passthrough();
...
const action = createAction({
    description: 'Retrieve a list of webhook event attempts in Resend. Returns one page; pass next_cursor as after to continue.',
    version: '1.0.0',
    input: InputSchema,
    output: OutputSchema,
    scopes: [],
