...
// Operation: emails/list-receiving-attachments
const InputSchema = z
    .object({ email_id: z.string(), limit: z.number().int().optional(), after: z.string().optional(), before: z.string().optional() })
    .passthrough();
...
const action = createAction({
    description: 'Retrieve a list of attachments for a received email in Resend. Returns one page; pass next_cursor as after to continue.',
    version: '1.0.0',
    input: InputSchema,
    output: OutputSchema,
    scopes: [],
