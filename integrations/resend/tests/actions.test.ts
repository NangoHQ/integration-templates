...
const cases = [
    ...
    { name: "remove-contact-from-segment", method: "delete", path: "/contacts/{contact_id}/segments/{segment_id}", hasBody: false, action: removeContactFromSegment },
    ...
    { name: "list-received-email-attachments", method: "get", path: "/emails/receiving/{email_id}/attachments", hasBody: false, action: listReceivedEmailAttachments },
    { name: "get-received-email-attachment", method: "get", path: "/emails/receiving/{email_id}/attachments/{attachment_id}", hasBody: false, action: getReceivedEmailAttachment },
    ...
    { name: "list-webhook-event-attempts", method: "get", path: "/webhooks/{webhook_id}/events/{event_id}/attempts", hasBody: false, action: listWebhookEventAttempts },
