...
import createSync from '../syncs/configured-search-results.js';

describe('exa configured-search-results tests', () => {
    const models = 'SearchResult'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'configured-search-results',
            Model: 'SearchResult'
        });
