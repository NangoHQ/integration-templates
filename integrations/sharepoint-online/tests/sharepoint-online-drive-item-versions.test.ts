...
import createSync from '../syncs/drive-item-versions.js';

describe('sharepoint-online drive-item-versions tests', () => {
    const models = 'DriveItemVersion'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'drive-item-versions',
            Model: 'DriveItemVersion'
        });
