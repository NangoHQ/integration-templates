...
const action = createAction({
    ...
    exec: async (nango, input): Promise<z.infer<typeof OutputSchema>> => {
        ...
        return {
            ...
            ...(providerData.is_deal_rot_enabled != null && { is_deal_rot_enabled: providerData.is_deal_rot_enabled }),
            ...(providerData.days_to_rotten != null && { days_to_rotten: providerData.days_to_rotten }),
