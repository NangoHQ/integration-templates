...
import createSync from '../syncs/conversation-parts.js';

describe('intercom conversation-parts tests', () => {
  const models = 'ConversationPart'.split(',');
  ...
  beforeEach(() => {
    vi.useFakeTimers();
    vi.setSystemTime(1778133182 * 1000);
  });
