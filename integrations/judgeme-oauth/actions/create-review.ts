...
const InputSchema = z
    .object({
        ...
        platform: z.enum(['shopify', 'woocommerce', 'bigcommerce']).describe('E-commerce platform. Example: "shopify"'),
        ...
        external_id: z.string().describe('The external (e.g. Shopify) product ID to attach the review to.')
    })
