...
// The mock was recorded when "now midnight UTC" was 2026-06-26T00:00:00.000Z.
// Freeze time to that instant so the computed date windows always match the fixture hashes.
const FROZEN_NOW = new Date('2026-06-26T00:00:00.000Z');

describe('fireflies analytics tests', () => {
    const models = 'Analytics'.split(',');
