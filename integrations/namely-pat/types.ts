...
export interface NamelyProfile {
    ...
    job_change_reason: 'New Hire' | 'Salary Change' | 'Promotion' | 'Transfer' | null;
    ...
    dob: string;
    ssn: string;
    marital_status: 'Single' | 'Married' | 'Civil Partnership' | 'Separated' | 'Divorced' | null;
    bio: string | null;
    asset_management: 'Laptop' | 'Cell Phone' | 'Building Keys' | 'Corporate Card' | 'Air Card';
