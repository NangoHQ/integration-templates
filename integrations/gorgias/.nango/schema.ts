...
export interface Ticket {
  ...
  meta: {  [key: string]: any;} | null;
  email: string | null;
  name: string | null;} | null | (string | string | number | null | string | boolean | string | null)[] | null | {  [key: string]: any;} | null | {  [key: string]: any;} | null | any[] | null | any[] | null | string | null | string | null | string | null | {  [key: string]: any;} | null | string | null | string | null | string | null)[];
  meta: {  [key: string]: any;} | null;
  opened_datetime: string | null;
  snooze_datetime: string | null;
  status: 'open' | 'closed';
  subject: string | null;
  tags: (number | string | string | null | {  [key: string]: any;} | null | string | null | string | null)[];
  spam: boolean | null;
