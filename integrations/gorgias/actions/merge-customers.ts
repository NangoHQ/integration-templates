...
const OutputSchema = z
    .object({
        ...
        firstname: z.string().nullable().optional().describe('First name of the merged customer (read-only, derived from name).'),
        lastname: z.string().nullable().optional().describe('Last name of the merged customer (read-only, derived from name).'),
