...
import createSync from '../syncs/pronunciation-dictionaries.js';

describe('elevenlabs pronunciation-dictionaries tests', () => {
    const models = 'PronunciationDictionary'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'pronunciation-dictionaries',
            Model: 'PronunciationDictionary'
        });
    ...
    it('should not call batchDelete directly (deletion is handled via trackDeletesEnd)', async () => {
