...
import createSync from '../syncs/incomplete-executions.js';

describe('make incomplete-executions tests', () => {
    const models = 'IncompleteExecution'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'incomplete-executions',
            Model: 'IncompleteExecution'
        });
