...
import createSync from '../syncs/global-suppressions.js';

describe('sendgrid global-suppressions tests', () => {
  const models = 'GlobalSuppression'.split(',');
