...
const MetadataSchema = z.object({
    spreadsheet_id: z.string().describe('Google Spreadsheet ID. Example: "1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms"'),
    sheet_name: z.string().optional().describe('Sheet/worksheet name. Defaults to first sheet if not provided. Example: "Sheet1"'),
...
const sync = createSync({
    ...
    version: '1.0.0',
    endpoints: [{ method: 'POST', path: '/syncs/sync-rows', group: 'Sheets' }],
