...
const WorksheetSchema = z.object({
    ...
    spreadsheetId: z.string().describe('ID of the parent spreadsheet'),
    ...
    rowCount: z.number().optional().describe('Number of rows in the grid (for GRID sheets)'),
    columnCount: z.number().optional().describe('Number of columns in the grid (for GRID sheets)'),
    hidden: z.boolean().optional().describe('Whether the sheet is hidden')
});

const MetadataSchema = z.object({
    spreadsheetId: z.string().describe('Google Sheets spreadsheet ID to sync worksheets from')
});
