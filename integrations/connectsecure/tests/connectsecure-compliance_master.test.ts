...
import createSync from '../syncs/compliance_master.js';

describe('connectsecure compliance_master tests', () => {
    const models = 'ComplianceMasterCheck'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'compliance_master',
            Model: 'ComplianceMasterCheck'
        });
