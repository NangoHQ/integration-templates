...
import createSync from '../syncs/keyword-criteria.js';

describe('google-ads keyword-criteria tests', () => {
    const models = 'KeywordCriterion'.split(',');

    const createTestContext = () => {
        const nangoMock = new global.vitest.NangoSyncMock({
            dirname: __dirname,
            name: 'keyword-criteria',
            Model: 'KeywordCriterion'
        });
