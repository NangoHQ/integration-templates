...
// recursively, so a high-churn window never silently loses changes beyond the first 10,000. If a
// window still saturates after MAX_CHANGE_STATUS_SPLIT_DEPTH splits (down to sub-second windows),
// we fail loudly instead of advancing the checkpoint past unseen changes.
