...
import fetchData from '../syncs/organization-locations.js';

describe('recruiterflow organization-locations tests', () => {
    ...
    const models = 'RecruiterFlowOrganizationLocation'.split(',');
