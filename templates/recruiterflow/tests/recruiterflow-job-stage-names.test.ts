...
import fetchData from '../syncs/job-stage-names.js';

describe('recruiterflow job-stage-names tests', () => {
    const nangoMock = new global.vitest.NangoSyncMock({
        dirname: __dirname,
        name: 'job-stage-names',
        Model: 'RecruiterFlowLeanJobStageName'
    });

    const models = 'RecruiterFlowLeanJobStageName'.split(',');
