...
import fetchData from '../syncs/job-remote-statuses.js';

describe('recruiterflow job-remote-statuses tests', () => {
    const nangoMock = new global.vitest.NangoSyncMock({
        dirname: __dirname,
        name: 'job-remote-statuses',
        Model: 'RecruiterFlowJobRemoteStatus'
    });

    const models = 'RecruiterFlowJobRemoteStatus'.split(',');
