...
import fetchData from '../syncs/candidate-activity-types.js';

describe('recruiterflow candidate-activity-types tests', () => {
    const nangoMock = new global.vitest.NangoSyncMock({
        dirname: __dirname,
        name: 'candidate-activity-types',
        Model: 'RecruiterFlowCandidateActivityType'
    });

    const models = 'RecruiterFlowCandidateActivityType'.split(',');
