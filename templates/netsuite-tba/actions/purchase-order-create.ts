...
import { NetsuitePurchaseOrderCreateOutput, NetsuitePurchaseOrderCreateInput } from "../models.js";
...
const action = createAction({
    ...
    exec: async (nango, input): Promise<NetsuitePurchaseOrderCreateOutput> => {
